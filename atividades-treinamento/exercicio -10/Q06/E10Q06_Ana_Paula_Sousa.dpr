...
e o produto. A classe Produto possui as seguintes informações:
código, nome, preço, desconto. Crie uma classe para os itens do Carrinho.
Na classe Carrinho crie uma coleção de itens. A Classe Carrinho deve ter
métodos para incluir e remover um item da coleção.
